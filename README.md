...
If you would like to destroy the environment, from the directory `gcp-vmseries-tf-2fw-hub-spoke-lab` in Google Cloud shell, enter the following commands into Google Cloud Shell from the directory.
